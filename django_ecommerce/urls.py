...
from accounts.urls import urlpatterns_accounts
...
from .views import pagina_casa, pagina_contacto, pagina_sobre_nosotros
...
urlpatterns = [
    ...
    url(r'^auth/', include(urlpatterns_accounts, namespace='auth')),
